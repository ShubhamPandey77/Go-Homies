  ...
  return (
    <footer className="bg-[#fefaf4] px-6 md:px-16 py-12 font-[Poppins]">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="md:flex justify-between items-start border-b border-gray-300 pb-10">
          ...
          <div className="max-w-md mb-8 md:mb-0">
            ...
            <p className="text-gray-600">
              Lorem ipsum consectetur amet dolor sit comeneer ilremlom dolce issilm 
              acalrm leinison duycoqu.
            </p>
          </div>
        ...
        {/* Links Section */}
        <div className="grid grid-cols-2 md:grid-cols-3 gap-12 mt-10 text-gray-700">
